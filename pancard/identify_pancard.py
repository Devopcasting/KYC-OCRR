...
class IdentifyPanCard:
    def __init__(self, clean_text: list) -> None:
        ...
        self.pancard_regex = r"\b(?:income|tax|incometax|department|permanent|petianent|incometaxdepartment|incombtaxdepartment|pormanent|perenent|tincometaxdepakinent)\b"
